    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addon_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.addon_category')),
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.menu')),
                ('menu_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.menu_category')),
            ],
        ),
        migrations.CreateModel(
            name='addon_items',
